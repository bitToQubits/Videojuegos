...
def title_screen(display_surface, screen):
    title = pygame.image.load('City of Rage/data/title.png').convert()   
    title = pygame.transform.scale(title, (640,480))
    background = pygame.image.load('City of Rage/data/City Street.gif').convert()
...
def main():
    ...
    #icon
    icon = pygame.image.load('City of Rage/data/axel.png')
    ...
    #images
    Axel_image = pygame.image.load('City of Rage/data/Genesis 32X SCD - Streets of Rage 2 - Axel.png').convert()
    hit_sparks_image = pygame.image.load('City of Rage/data/hit_spark.png').convert()
    background = pygame.image.load('City of Rage/data/City Street.gif').convert()
