...
import Explont.data.tile_map as tile_map
import Explont.data.spritesheet_loader as spritesheet_loader
from Explont.data.foliage import AnimatedFoliage
from Explont.data.entity import Entity, outline
from Explont.data.anim_loader import AnimationManager
from Explont.data.grass import GrassManager
from Explont.data.text import Font
from Explont.data.particles import Particle, load_particle_images
...
def explont():
    ...
    class GameData:
        ...
        def reset(self):
            ...
            self.clouds = []
            self.grass_manager = GrassManager('Explont/data/images/grass', tile_size=16)
        ...
        def load_map(self, name):
            ...
            self.level_map.load_map('Explont/data/maps/' + name + '.json')
    ...
    spritesheets, spritesheets_data = spritesheet_loader.load_spritesheets('Explont/data/images/spritesheets/')

    foliage_animations = [AnimatedFoliage(load_img('Explont/data/images/foliage/' + str(i) + '.png'), [[23, 67, 75], [100, 125, 52], [192, 199, 65]], motion_scale=0.5) for i in range(3)]

    load_particle_images('Explont/data/images/particles')

    anger_icon_1 = load_img('Explont/data/images/anger_icon_1.png')
    anger_icon_2 = load_img('Explont/data/images/anger_icon_2.png')
    anger_s1 = load_img('Explont/data/images/anger_1.png')
    anger_s2 = load_img('Explont/data/images/anger_2.png')
    anger_bar = load_img('Explont/data/images/anger_bar.png')
    anger_bar_end = load_img('Explont/data/images/anger_bar_end.png')
    anger_bar_end_white = load_img('Explont/data/images/anger_bar_end_white.png')
    bg_img = load_img('Explont/data/images/bg.png')
    gun_img = load_img('Explont/data/images/gun.png')
    lollipop_img = load_img('Explont/data/images/lollipop.png')
    warp_img = load_img('Explont/data/images/warp.png')
    hit_overlay_img = load_img('Explont/data/images/hit_overlay.png')
    tutorial_img = load_img('Explont/data/images/tutorial.png')

    cloud_images = [load_img('Explont/data/images/clouds/cloud_' + str(i + 1) + '.png') for i in range(3)]

    font_white = Font('Explont/data/fonts/large_font.png', (247, 237, 186))
    font_black = Font('Explont/data/fonts/large_font.png', (31, 14, 28))

    sounds = {sound.split('/')[-1].split('.')[0] : pygame.mixer.Sound('Explont/data/sfx/' + sound) for sound in os.listdir('Explont/data/sfx')}
    ...
    pygame.mixer.music.load('Explont/data/music.ogg')
    ...
    while True:
        ...
        if gd.level_notice:
            ...
            font_black.render('atrapa y come', display, (l_pos[0] - 1, l_pos[1]))
            font_black.render('atrapa y come', display, (l_pos[0] + 1, l_pos[1]))
            font_black.render('atrapa y come', display, (l_pos[0], l_pos[1] + 1))
            font_black.render('atrapa y come', display, (l_pos[0], l_pos[1] - 1))
            font_white.render('atrapa y come', display, l_pos)
