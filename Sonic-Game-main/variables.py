...
states_sonic = [[], []]
states_sonic[0].append(pygame.image.load("Sonic-game-main/images/sonic1.gif").convert_alpha())
states_sonic[0].append(pygame.image.load("Sonic-game-main/images/sonic2.gif").convert_alpha())
states_sonic[0].append(pygame.image.load("Sonic-game-main/images/sonic3.gif").convert_alpha())
states_sonic[0].append(pygame.image.load("Sonic-game-main/images/sonic4.gif").convert_alpha())
states_sonic[1].append(pygame.image.load(
    "Sonic-game-main/images/sonicStanding1.gif").convert_alpha())
states_sonic[1].append(pygame.image.load(
    "Sonic-game-main/images/sonicStanding2.gif").convert_alpha())

# le canard en gif
states_duck = []
states_duck.append(pygame.image.load("Sonic-game-main/images/duck1.png").convert_alpha())
states_duck.append(pygame.image.load("Sonic-game-main/images/duck2.png").convert_alpha())
# init des enemies
enemy_spike_surface = pygame.image.load("Sonic-game-main/images/spike.png").convert_alpha()
enemy_bird_surface = pygame.image.load("Sonic-game-main/images/bird.png").convert_alpha()
rock_surface = pygame.image.load("Sonic-game-main/images/rock.png").convert_alpha()
enemies = []
# sonic en saut
sonic_jump_surface = pygame.image.load("Sonic-game-main/images/sonicJump.png").convert_alpha()

# le coeur
heart_surface = pygame.image.load("Sonic-game-main/images/heart.png").convert_alpha()

grass_surface = pygame.image.load("Sonic-game-main/images/grass.png").convert_alpha()
...
cloud_surface = pygame.image.load("Sonic-game-main/images/cloud.png").convert_alpha()
...
palm_surface = pygame.image.load("Sonic-game-main/images/palm-min.png").convert_alpha()
palm_2_surface = pygame.image.load("Sonic-game-main/images/palm2-min.png").convert_alpha()
...
#LES SONS#
##########
HEALINGPATH = "Sonic-game-main/sounds/healing.wav"
JUMPPATH = "Sonic-game-main/sounds/jump.mp3"
DAMAGEPATH = "Sonic-game-main/sounds/damage.wav"
LOSTPATH = "Sonic-game-main/sounds/lost.wav"
SCOREPATH = "Sonic-game-main/sounds/score.wav"
SCORE1000PATH = "Sonic-game-main/sounds/best_score.wav"
BESTSCOREPATH = "Sonic-game-main/sounds/best_score.wav"
MAINMUSIC = "Sonic-game-main/sounds/mainMusic.wav"
####################
#TEXTES SUR L'ECRAN#
####################

scoreTimer = time()
FONTPATH = "Sonic-game-main/font/BACKTO1982.TTF"
...
# background music
pygame.mixer.init()
pygame.mixer.music.load("Sonic-game-main/sounds/mainMusic.wav")
