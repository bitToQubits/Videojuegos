...
import TempestRun.util.profiling as profiling
import TempestRun.util.fonts as fonts
from TempestRun.sound_manager.SoundManager import SoundManager
import TempestRun.rendering.levelbuilder3d as levelbuilder3d
import TempestRun.gameplay.highscores as highscores
import TempestRun.util.utility_functions as utils
...
class MainMenuMode(GameMode):
    ...
    def __init__(self, loop: GameLoop):
        ...
        import TempestRun.gameplay.levels as levels
        import TempestRun.rendering.threedee as threedee
        import TempestRun.rendering.neon as neon
    ...
    def start_pressed(self):
        import TempestRun.gameplay.gamestuff # shh don't tell pylint about this
        self.loop.set_mode(TempestRun.gameplay.gamestuff.GameplayMode(self.loop))

    def help_pressed(self):
        import TempestRun.menus.help_menu as help_menu
        self.loop.set_mode(help_menu.HelpMenuMode(self.loop, self))

    def settings_pressed(self):
        import TempestRun.menus.settings_menu as settings_menu
        self.loop.set_mode(settings_menu.SettingsMenuMode(self.loop))

    def credits_pressed(self):
        import TempestRun.menus.credits_menu as credits_menu
...
def create_or_recreate_window():
    ...
    pygame.display.set_icon(pygame.image.load(utils.resource_path("TempestRun/assets/icon/icon.png")))
