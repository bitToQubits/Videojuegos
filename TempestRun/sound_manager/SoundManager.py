...
class SoundManager:
    ...
    SOUND_PATHS = {
        'death': 'TempestRun/assets/sounds/death',
        'jump': 'TempestRun/assets/sounds/jump',
        'kill': 'TempestRun/assets/sounds/kill',
        'accept': 'TempestRun/assets/sounds/accept',
        'blip': 'TempestRun/assets/sounds/blip',
        'blip2': 'TempestRun/assets/sounds/blip2',
        'start_elison':'TempestRun/assets/sounds/start_elison',
    }
    ...
    SONG_PATHS = {
        "menu_theme": "TempestRun/assets/songs/menu_theme.ogg",
        "game_theme": "TempestRun/assets/songs/game_theme.ogg"
    }
