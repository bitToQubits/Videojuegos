...
import Tempest.keybinds as keybinds
import Tempest.rendering.neon as neon
import Tempest.config as config
import Tempest.util.profiling as profiling
import Tempest.util.fonts as fonts
from Tempest.sound_manager.SoundManager import SoundManager
import Tempest.rendering.levelbuilder3d as levelbuilder3d
import Tempest.gameplay.highscores as highscores
import Tempest.util.utility_functions as utils
...
def tempest():
    ...
    class MainMenuMode(GameMode):
        ...
        def __init__(self, loop: GameLoop):
            ...
            import Tempest.gameplay.levels as levels
            import Tempest.rendering.threedee as threedee
            import Tempest.rendering.neon as neon
        ...
        def on_mode_start(self):
            SoundManager.play_song("menu_theme", fadein_ms=15000)

        def start_pressed(self):
            import Tempest.gameplay.gamestuff as gameplay # shh don't tell pylint about this
    ...
    def create_or_recreate_window():
        ...
        pygame.display.set_icon(pygame.image.load(utils.resource_path("Tempest/assets/icon/icon.png")))
