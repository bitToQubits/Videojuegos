...
import Tempest.main as main
import Tempest.gameplay.player2d as player2d
...
import Tempest.util.utility_functions as utility_functions
...
class GameplayMode(main.tempest().GameMode):
    ...
    def on_mode_start(self):
        ...
        soundm = SoundManager.set_song_volume_multiplier(0.1)
        print(SoundManager.get_song_volume())
